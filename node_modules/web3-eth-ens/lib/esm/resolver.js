...
export class Resolver {
    ...
    setAddress(ENSName, address, txConfig, returnFormat = DEFAULT_RETURN_FORMAT) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    setPubkey(ENSName, x, y, txConfig) {
        return __awaiter(this, void 0, void 0, function* () {
            const resolverContract = yield this.getResolverContractAdapter(ENSName);
            yield this.checkInterfaceSupport(resolverContract, methodsInInterface.setPubkey);
    ...
    setContenthash(ENSName, hash, txConfig) {
        return __awaiter(this, void 0, void 0, function* () {
            const resolverContract = yield this.getResolverContractAdapter(ENSName);
            yield this.checkInterfaceSupport(resolverContract, methodsInInterface.setContenthash);
