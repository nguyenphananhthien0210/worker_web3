...
class ENS extends web3_core_1.Web3Context {
    ...
    constructor(registryAddr, provider) {
        ...
        this.registryAddress = registryAddr !== null && registryAddr !== void 0 ? registryAddr : config_1.registryAddresses.main; // will default to main registry address
     ...
     * ```
     */
    setResolver(name, address, txConfig, returnFormat = web3_types_1.DEFAULT_RETURN_FORMAT) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * ```
     */
    setSubnodeRecord(name, label, owner, resolver, ttl, txConfig, returnFormat = web3_types_1.DEFAULT_RETURN_FORMAT) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * ```
     */
    isApprovedForAll(owner, operator, returnFormat = web3_types_1.DEFAULT_RETURN_FORMAT) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * ```
     */
    setSubnodeOwner(node, label, address, txConfig, returnFormat = web3_types_1.DEFAULT_RETURN_FORMAT) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * ```
     */
    setOwner(name, address, txConfig, returnFormat = web3_types_1.DEFAULT_RETURN_FORMAT) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     *```
     */
    setAddress(name, address, txConfig, returnFormat = web3_types_1.DEFAULT_RETURN_FORMAT) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    checkNetwork() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const addr = config_1.registryAddresses[config_1.networkIds[networkType]];
