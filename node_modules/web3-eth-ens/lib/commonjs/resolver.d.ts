...
export declare class Resolver {
    ...
    setAddress(ENSName: string, address: Address, txConfig: NonPayableCallOptions, returnFormat?: DataFormat): Promise<{
    ...
    setPubkey(ENSName: string, x: string, y: string, txConfig: NonPayableCallOptions): Promise<{
        readonly transactionHash: string;
        readonly transactionIndex: bigint;
        readonly blockHash: string;
        readonly blockNumber: bigint;
    ...
    setContenthash(ENSName: string, hash: string, txConfig: NonPayableCallOptions): Promise<{
        readonly transactionHash: string;
        readonly transactionIndex: bigint;
        readonly blockHash: string;
        readonly blockNumber: bigint;
