...
class RpcError extends web3_error_base_1.BaseWeb3Error {
...
class ParseError extends RpcError {
    constructor(rpcError) {
        ...
        this.code = error_codes_1.ERR_RPC_INVALID_JSON;
    }
}
...
class InvalidRequestError extends RpcError {
    constructor(rpcError) {
        ...
        this.code = error_codes_1.ERR_RPC_INVALID_REQUEST;
    }
}
...
class MethodNotFoundError extends RpcError {
    constructor(rpcError) {
        ...
        this.code = error_codes_1.ERR_RPC_INVALID_METHOD;
    }
}
...
class InvalidParamsError extends RpcError {
    constructor(rpcError) {
        super(rpcError, 'Invalid request');
        this.code = error_codes_1.ERR_RPC_INVALID_PARAMS;
    }
}
...
class InternalError extends RpcError {
    constructor(rpcError) {
        ...
        this.code = error_codes_1.ERR_RPC_INTERNAL_ERROR;
    }
}
...
class InvalidInputError extends RpcError {
    constructor(rpcError) {
        ...
        this.code = error_codes_1.ERR_RPC_INVALID_INPUT;
    }
}
...
class MethodNotSupported extends RpcError {
    constructor(rpcError) {
        ...
        this.code = error_codes_1.ERR_RPC_UNSUPPORTED_METHOD;
    }
}
...
class ResourceUnavailableError extends RpcError {
    constructor(rpcError) {
        ...
        this.code = error_codes_1.ERR_RPC_UNAVAILABLE_RESOURCE;
    }
}
...
class ResourcesNotFoundError extends RpcError {
    constructor(rpcError) {
        ...
        this.code = error_codes_1.ERR_RPC_MISSING_RESOURCE;
    }
}
...
class VersionNotSupportedError extends RpcError {
    constructor(rpcError) {
        ...
        this.code = error_codes_1.ERR_RPC_NOT_SUPPORTED;
    }
}
...
class TransactionRejectedError extends RpcError {
    constructor(rpcError) {
        ...
        this.code = error_codes_1.ERR_RPC_TRANSACTION_REJECTED;
    }
}
...
class LimitExceededError extends RpcError {
    constructor(rpcError) {
        ...
        this.code = error_codes_1.ERR_RPC_LIMIT_EXCEEDED;
    }
}
exports.LimitExceededError = LimitExceededError;
exports.rpcErrorsMap = new Map();
exports.rpcErrorsMap.set(error_codes_1.ERR_RPC_INVALID_JSON, { error: ParseError });
exports.rpcErrorsMap.set(error_codes_1.ERR_RPC_INVALID_REQUEST, {
    error: InvalidRequestError,
});
exports.rpcErrorsMap.set(error_codes_1.ERR_RPC_INVALID_METHOD, {
    error: MethodNotFoundError,
});
exports.rpcErrorsMap.set(error_codes_1.ERR_RPC_INVALID_PARAMS, { error: InvalidParamsError });
exports.rpcErrorsMap.set(error_codes_1.ERR_RPC_INTERNAL_ERROR, { error: InternalError });
exports.rpcErrorsMap.set(error_codes_1.ERR_RPC_INVALID_INPUT, { error: InvalidInputError });
exports.rpcErrorsMap.set(error_codes_1.ERR_RPC_UNSUPPORTED_METHOD, {
    error: MethodNotSupported,
});
exports.rpcErrorsMap.set(error_codes_1.ERR_RPC_UNAVAILABLE_RESOURCE, {
    error: ResourceUnavailableError,
});
exports.rpcErrorsMap.set(error_codes_1.ERR_RPC_TRANSACTION_REJECTED, {
    error: TransactionRejectedError,
});
exports.rpcErrorsMap.set(error_codes_1.ERR_RPC_MISSING_RESOURCE, {
    error: ResourcesNotFoundError,
});
exports.rpcErrorsMap.set(error_codes_1.ERR_RPC_NOT_SUPPORTED, {
    error: VersionNotSupportedError,
});
exports.rpcErrorsMap.set(error_codes_1.ERR_RPC_LIMIT_EXCEEDED, { error: LimitExceededError });
