...
const web3_eip1193_provider_1 = require("./web3_eip1193_provider");
const chunk_response_parser_1 = require("./chunk_response_parser");
const validation_1 = require("./validation");
const web3_deferred_promise_1 = require("./web3_deferred_promise");
const jsonRpc = __importStar(require("./json_rpc"));
...
class SocketProvider extends web3_eip1193_provider_1.Eip1193Provider {
    /**
    ...
    constructor(socketPath, socketOptions, reconnectOptions) {
        ...
        this._init();
        this.connect();
        this.chunkResponseParser = new chunk_response_parser_1.ChunkResponseParser(this._eventEmitter, this._reconnectOptions.autoReconnect);
    ...
    request(request) {
        return __awaiter(this, void 0, void 0, function* () {
            if ((0, validation_1.isNullish)(this._socketConnection)) {
            ...
            const deferredPromise = new web3_deferred_promise_1.Web3DeferredPromise();
