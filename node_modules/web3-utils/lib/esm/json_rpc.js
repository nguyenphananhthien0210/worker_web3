...
export const isBatchResponse = (response) => Array.isArray(response) && response.length > 1 && isValidResponse(response);
...
export const isBatchRequest = (request) => Array.isArray(request) && request.length > 1;
