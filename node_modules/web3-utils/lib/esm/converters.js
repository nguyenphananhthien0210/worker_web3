...
*/
import { isAddress, isHex, isHexStrict, isNullish, utils as validatorUtils, validator, } from 'web3-validator';
 ...
 * ```
 */
export const bytesToBuffer = (data) => {
 ...
 * > "0x0c12"
 */
export const bytesToHex = (bytes) => bufferToHexString(bytesToBuffer(bytes));
/**
 ...
 * ```
 */
export const hexToBytes = (bytes) => bytesToBuffer(bytes);
/**
 ...
 * ```
 */
export const hexToUtf8 = (str) => bytesToBuffer(str).toString('utf8');
/**
 * @alias hexToUtf8
 */
 ...
 * ```
 */
export const hexToAscii = (str) => bytesToBuffer(str).toString('ascii');
/**
 * @alias hexToAscii
 */
