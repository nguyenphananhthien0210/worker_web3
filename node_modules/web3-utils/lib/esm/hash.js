...
*/
import { InvalidStringError, InvalidBooleanError, InvalidAddressError, InvalidSizeError, InvalidLargeValueError, InvalidUnsignedIntegerError, InvalidBytesError, } from 'web3-errors';
...
import { utf8ToHex, hexToBytes, toNumber, bytesToHex, bytesToBuffer, toHex, toBigInt, } from './converters';
...
export const sha3 = (data) => {
    ...
    const hash = bytesToHex(keccak256(Buffer.from(updatedData)));
