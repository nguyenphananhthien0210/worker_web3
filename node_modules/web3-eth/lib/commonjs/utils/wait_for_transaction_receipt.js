...
// eslint-disable-next-line import/no-cycle
const reject_if_block_timeout_1 = require("./reject_if_block_timeout");
// eslint-disable-next-line import/no-cycle
...
function waitForTransactionReceipt(web3Context, transactionHash, returnFormat) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const awaitableTransactionReceipt = (0, web3_utils_1.pollTillDefined)(() => __awaiter(this, void 0, void 0, function* () {
            try {
                return (0, rpc_method_wrappers_1.getTransactionReceipt)(web3Context, transactionHash, returnFormat);
            }
            catch (error) {
        ...
        const [rejectOnBlockTimeout, blockTimeoutResourceCleaner] = yield (0, reject_if_block_timeout_1.rejectIfBlockTimeout)(web3Context, transactionHash);
        try {
