...
const rpc_method_wrappers_1 = require("../rpc_method_wrappers");
const detect_transaction_type_1 = require("./detect_transaction_type");
// eslint-disable-next-line import/no-cycle
const get_transaction_gas_pricing_1 = require("./get_transaction_gas_pricing");
    ...
    if (transaction !== undefined && attr in transaction && transaction[attr] !== undefined) {
        ...
        if (!(0, web3_validator_1.isHexStrict)(transaction[attr]) && (0, web3_validator_1.isNumber)(transaction[attr])) {
            if (web3Context.wallet) {
                const account = web3Context.wallet.get((0, web3_utils_1.format)({ eth: 'uint' }, transaction[attr], constants_1.NUMBER_DATA_FORMAT));
...
const getTransactionNonce = (web3Context, address, returnFormat = web3_types_1.DEFAULT_RETURN_FORMAT) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return (0, rpc_method_wrappers_1.getTransactionCount)(web3Context, address, web3Context.defaultBlock, returnFormat);
});
exports.getTransactionNonce = getTransactionNonce;
const getTransactionType = (transaction, web3Context) => {
    const inferredType = (0, detect_transaction_type_1.detectTransactionType)(transaction, web3Context);
    if (!(0, web3_validator_1.isNullish)(inferredType))
        return inferredType;
    if (!(0, web3_validator_1.isNullish)(web3Context.defaultTransactionType))
        return (0, web3_utils_1.format)({ eth: 'uint' }, web3Context.defaultTransactionType, web3_types_1.ETH_DATA_FORMAT);
    return undefined;
};
...
function defaultTransactionBuilder(options) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let populatedTransaction = (0, web3_utils_1.format)(schemas_1.transactionSchema, options.transaction, web3_types_1.DEFAULT_RETURN_FORMAT);
        ...
        if (!(0, web3_validator_1.isNullish)(populatedTransaction.data) && !(0, web3_validator_1.isNullish)(populatedTransaction.input)) {
            throw new web3_errors_1.TransactionDataAndInputError({
                data: populatedTransaction.data,
                input: populatedTransaction.input,
            });
        }
        else if (!(0, web3_validator_1.isNullish)(populatedTransaction.data)) {
            populatedTransaction.input = populatedTransaction.data;
            delete populatedTransaction.data;
        }
        if ((0, web3_validator_1.isNullish)(populatedTransaction.input) || populatedTransaction.input === '') {
        ...
        if ((0, web3_validator_1.isNullish)(populatedTransaction.chainId) &&
            ...
            populatedTransaction.chainId = yield (0, rpc_method_wrappers_1.getChainId)(options.web3Context, web3_types_1.ETH_DATA_FORMAT);
        }
        ...
        populatedTransaction = Object.assign(Object.assign({}, populatedTransaction), (yield (0, get_transaction_gas_pricing_1.getTransactionGasPricing)(populatedTransaction, options.web3Context, web3_types_1.ETH_DATA_FORMAT)));
