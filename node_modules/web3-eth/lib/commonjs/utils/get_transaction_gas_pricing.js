...
function getEip1559GasPricing(transaction, web3Context, returnFormat) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        const block = yield (0, rpc_method_wrappers_1.getBlock)(web3Context, web3Context.defaultBlock, false, returnFormat);
        ...
        if (!(0, web3_validator_1.isNullish)(transaction.gasPrice)) {
            const convertedTransactionGasPrice = (0, web3_utils_1.format)({ eth: 'uint' }, transaction.gasPrice, returnFormat);
            return {
        ...
        return {
            maxPriorityFeePerGas: (0, web3_utils_1.format)({ eth: 'uint' }, (_a = transaction.maxPriorityFeePerGas) !== null && _a !== void 0 ? _a : web3Context.defaultMaxPriorityFeePerGas, returnFormat),
            maxFeePerGas: (0, web3_utils_1.format)({ eth: 'uint' }, ((_b = transaction.maxFeePerGas) !== null && _b !== void 0 ? _b : BigInt(block.baseFeePerGas) * BigInt(2) +
...
function getTransactionGasPricing(transaction, web3Context, returnFormat) {
    return __awaiter(this, void 0, void 0, function* () {
        const transactionType = (0, transaction_builder_1.getTransactionType)(transaction, web3Context);
        if (!(0, web3_validator_1.isNullish)(transactionType)) {
            ...
            if ((0, web3_validator_1.isNullish)(transaction.gasPrice) &&
                ...
                return {
                    gasPrice: yield (0, rpc_method_wrappers_1.getGasPrice)(web3Context, returnFormat),
