...
function resolveByPolling(web3Context, starterBlockNumber, transactionHash) {
    ...
    const [intervalId, promiseToError] = (0, web3_utils_1.rejectIfConditionAtInterval)(() => __awaiter(this, void 0, void 0, function* () {
        let lastBlockNumber;
        try {
            lastBlockNumber = yield (0, rpc_method_wrappers_1.getBlockNumber)(web3Context, constants_1.NUMBER_DATA_FORMAT);
        }
        catch (error) {
...
function rejectIfBlockTimeout(web3Context, transactionHash) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let callingRes;
        const starterBlockNumber = yield (0, rpc_method_wrappers_1.getBlockNumber)(web3Context, constants_1.NUMBER_DATA_FORMAT);
