...
const watch_transaction_by_pooling_1 = require("./watch_transaction_by_pooling");
const watch_transaction_by_subscription_1 = require("./watch_transaction_by_subscription");
function watchTransactionForConfirmations(web3Context, transactionPromiEvent, transactionReceipt, transactionHash, returnFormat) {
    if ((0, web3_validator_1.isNullish)(transactionReceipt) || (0, web3_validator_1.isNullish)(transactionReceipt.blockHash))
        throw new web3_errors_1.TransactionMissingReceiptOrBlockHashError({
            ...
            blockHash: (0, web3_utils_1.format)({ eth: 'bytes32' }, transactionReceipt === null || transactionReceipt === void 0 ? void 0 : transactionReceipt.blockHash, returnFormat),
    ...
    if (provider.supportsSubscriptions()) {
        (0, watch_transaction_by_subscription_1.watchTransactionBySubscription)({
            web3Context,
            transactionReceipt,
        ...
        (0, watch_transaction_by_pooling_1.watchTransactionByPolling)({
            web3Context,
            transactionReceipt,
            transactionPromiEvent,
            returnFormat,
