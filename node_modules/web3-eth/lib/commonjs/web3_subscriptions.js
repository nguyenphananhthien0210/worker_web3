...
class LogsSubscription extends web3_core_1.Web3Subscription {
    ...
    _processSubscriptionResult(data) {
        this.emit('data', (0, web3_utils_1.format)(schemas_1.logSchema, data, super.returnFormat));
    }
...
class NewPendingTransactionsSubscription extends web3_core_1.Web3Subscription {
    ...
    _processSubscriptionResult(data) {
        this.emit('data', (0, web3_utils_1.format)({ eth: 'string' }, data, super.returnFormat));
    }
    _processSubscriptionError(error) {
        this.emit('error', error);
    }
...
class NewHeadsSubscription extends web3_core_1.Web3Subscription {
    ...
    _processSubscriptionResult(data) {
        this.emit('data', (0, web3_utils_1.format)(schemas_1.blockHeaderSchema, data, super.returnFormat));
    }
    _processSubscriptionError(error) {
        this.emit('error', error);
    }
...
class SyncingSubscription extends web3_core_1.Web3Subscription {
    ...
    _processSubscriptionResult(data) {
        if (typeof data === 'boolean') {
            ...
            this.emit('data', (0, web3_utils_1.format)(schemas_1.syncSchema, mappedData, super.returnFormat));
        }
    }
    _processSubscriptionError(error) {
        this.emit('error', error);
