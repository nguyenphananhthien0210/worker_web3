...
function getEip1559GasPricing(transaction, web3Context, returnFormat) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!isNullish(transaction.gasPrice)) {
            const convertedTransactionGasPrice = format({ eth: 'uint' }, transaction.gasPrice, returnFormat);
            return {
        ...
        return {
            maxPriorityFeePerGas: format({ eth: 'uint' }, (_a = transaction.maxPriorityFeePerGas) !== null && _a !== void 0 ? _a : web3Context.defaultMaxPriorityFeePerGas, returnFormat),
            maxFeePerGas: format({ eth: 'uint' }, ((_b = transaction.maxFeePerGas) !== null && _b !== void 0 ? _b : BigInt(block.baseFeePerGas) * BigInt(2) +
