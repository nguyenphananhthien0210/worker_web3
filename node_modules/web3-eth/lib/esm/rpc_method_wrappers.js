...
import { accountSchema, blockSchema, feeHistorySchema, logSchema, transactionReceiptSchema, transactionInfoSchema, accessListResultSchema, } from './schemas';
...
export function getHashRate(web3Context, returnFormat) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return format({ eth: 'uint' }, response, returnFormat);
    });
}
/**
 * @param web3Context ({@link Web3Context}) Web3 configuration object that contains things such as the provider, request manager, wallet, etc.
...
export function getBalance(web3Context, address, blockNumber = web3Context.defaultBlock, returnFormat) {
    return __awaiter(this, void 0, void 0, function* () {
        const blockNumberFormatted = isBlockTag(blockNumber)
            ? blockNumber
            : format({ eth: 'uint' }, blockNumber, ETH_DATA_FORMAT);
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (isBytes(block)) {
            ...
            const blockNumberFormatted = isBlockTag(block)
                ? block
                : format({ eth: 'uint' }, block, ETH_DATA_FORMAT);
...
export function getTransaction(web3Context, transactionHash, returnFormat) {
    return __awaiter(this, void 0, void 0, function* () {
        const transactionHashFormatted = format({ eth: 'bytes32' }, transactionHash, DEFAULT_RETURN_FORMAT);
        ...
        setImmediate(() => {
            (() => __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    const transactionHashFormatted = format({ eth: 'bytes32' }, transactionHash, returnFormat);
    ...
    const promiEvent = new Web3PromiEvent((resolve, reject) => {
        setImmediate(() => {
            (() => __awaiter(this, void 0, void 0, function* () {
                ...
                const signedTransactionFormattedHex = format({ eth: 'bytes' }, signedTransaction, ETH_DATA_FORMAT);
                const unSerializedTransaction = TransactionFactory.fromSerializedData(bytesToBuffer(hexToBytes(signedTransactionFormattedHex)));
...
export function signTransaction(web3Context, transaction, returnFormat) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return isString(response)
            ...
            : {
                raw: format({ eth: 'bytes' }, response.raw, returnFormat),
...
export function getProof(web3Context, address, storageKeys, blockNumber = web3Context.defaultBlock, returnFormat) {
    return __awaiter(this, void 0, void 0, function* () {
        const storageKeysFormatted = storageKeys.map(storageKey => format({ eth: 'bytes' }, storageKey, ETH_DATA_FORMAT));
        const blockNumberFormatted = isBlockTag(blockNumber)
            ? blockNumber
            : format({ eth: 'uint' }, blockNumber, ETH_DATA_FORMAT);
...
export function getFeeHistory(web3Context, blockCount, newestBlock = web3Context.defaultBlock, rewardPercentiles, returnFormat) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const newestBlockFormatted = isBlockTag(newestBlock)
            ? newestBlock
            : format({ eth: 'uint' }, newestBlock, ETH_DATA_FORMAT);
