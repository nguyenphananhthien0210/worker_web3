import { TransactionForAccessList, AbiFunctionFragment, TransactionWithSenderAPI, TransactionCall, NonPayableCallOptions, PayableCallOptions, ContractInitOptions } from 'web3-types';
import { ContractOptions } from './types';
export declare const getSendTxParams: ({ abi, params, options, contractOptions, }: {
    abi: AbiFunctionFragment;
    params: unknown[];
    options?: NonPayableCallOptions | PayableCallOptions | undefined;
...
export declare const isWeb3ContractContext: (options: unknown) => options is Partial<import("web3-core").Web3ContextInitOptions<import("web3-types").EthExecutionAPI, {
    logs: typeof import("./log_subscription").LogsSubscription;
