...
const getSendTxParams = ({ abi, params, options, contractOptions, }) => {
    ...
    if (!txParams.input || abi.type === 'constructor') {
        txParams = Object.assign(Object.assign({}, txParams), { input: (0, encoding_1.encodeMethodABI)(abi, params, txParams.input) });
    }
    return txParams;
};
...
const getEthTxCallParams = ({ abi, params, options, contractOptions, }) => {
    ...
    txParams = Object.assign(Object.assign({}, txParams), { input: (0, encoding_1.encodeMethodABI)(abi, params, txParams.input ? (0, web3_utils_1.toHex)(txParams.input) : undefined) });
    return txParams;
};
