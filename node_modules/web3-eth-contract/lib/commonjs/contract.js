...
class Contract extends web3_core_1.Web3Context {
    ...
    deploy(deployOptions) {
        ...
        const _input = (0, web3_utils_1.format)({ eth: 'bytes' }, (_b = (_a = deployOptions === null || deployOptions === void 0 ? void 0 : deployOptions.input) !== null && _a !== void 0 ? _a : deployOptions === null || deployOptions === void 0 ? void 0 : deployOptions.data) !== null && _b !== void 0 ? _b : this.options.input, web3_types_1.DEFAULT_RETURN_FORMAT);
        ...
        return {
            ...
            encodeABI: () => (0, encoding_1.encodeMethodABI)(abi, args, (0, web3_utils_1.format)({ eth: 'bytes' }, _input, web3_types_1.DEFAULT_RETURN_FORMAT)),
        };
    }
