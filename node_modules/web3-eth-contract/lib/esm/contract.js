...
import { getCreateAccessListParams, getEstimateGasParams, getEthTxCallParams, getSendTxParams, isContractInitOptions, isWeb3ContractContext, } from './utils';
...
export class Contract extends Web3Context {
    ...
    deploy(deployOptions) {
        ...
        const _input = format({ eth: 'bytes' }, (_b = (_a = deployOptions === null || deployOptions === void 0 ? void 0 : deployOptions.input) !== null && _a !== void 0 ? _a : deployOptions === null || deployOptions === void 0 ? void 0 : deployOptions.data) !== null && _b !== void 0 ? _b : this.options.input, DEFAULT_RETURN_FORMAT);
        ...
        return {
            ...
            encodeABI: () => encodeMethodABI(abi, args, format({ eth: 'bytes' }, _input, DEFAULT_RETURN_FORMAT)),
        };
    }
    getPastEvents(param1, param2, param3) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { fromBlock, toBlock, topics, address } = encodeEventABI(this.options, abi, filter !== null && filter !== void 0 ? filter : {});
