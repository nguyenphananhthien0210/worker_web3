...
const isUInt = (value, options = {
    ...
    try {
        const valueToCheck = typeof value === 'string' && (0, string_1.isHexStrict)(value)
            ? BigInt((0, utils_1.hexToNumber)(value))
            : BigInt(value);
...
const isInt = (value, options = {
    ...
    let size;
    if (options === null || options === void 0 ? void 0 : options.abiType) {
        const { baseTypeSize, baseType } = (0, utils_1.parseBaseType)(options.abiType);
        if (baseType !== 'int') {
            return false;
        }
        if (baseTypeSize) {
