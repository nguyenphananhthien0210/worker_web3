import { FullValidationSchema, JsonSchema, ShortValidationSchema, ValidationSchemaInput, ValidInputTypes } from './types';
...
export declare const abiSchemaToJsonSchema: (abis: ShortValidationSchema | FullValidationSchema, level?: string) => JsonSchema;
export declare const ethAbiToJsonSchema: (abis: ValidationSchemaInput) => JsonSchema;
