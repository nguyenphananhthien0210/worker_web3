...
const transactionFactory_1 = require("./tx/transactionFactory");
...
const recoverTransaction = (rawTransaction) => {
    ...
    const tx = transactionFactory_1.TransactionFactory.fromSerializedData(Buffer.from(rawTransaction.slice(2), 'hex'));
