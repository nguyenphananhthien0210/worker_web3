...
const goerli_json_1 = __importDefault(require("./chains/goerli.json"));
const mainnet_json_1 = __importDefault(require("./chains/mainnet.json"));
const sepolia_json_1 = __importDefault(require("./chains/sepolia.json"));
...
class Common extends events_1.EventEmitter {
    constructor(opts) {
        ...
        this.DEFAULT_HARDFORK = (_b = this._chainParams.defaultHardfork) !== null && _b !== void 0 ? _b : enums_1.Hardfork.Merge;
    ...
    static custom(chainParamsOrName, opts = {}) {
        ...
        if (chainParamsOrName === enums_1.CustomChain.OptimisticKovan) {
            return Common.custom({
                ...
                chainId: 69,
                networkId: 69,
            }, Object.assign({ hardfork: enums_1.Hardfork.Berlin }, opts));
        }
    ...
    getHardforkByBlockNumber(_blockNumber, _td, _timestamp) {
        const blockNumber = (0, utils_1.toType)(_blockNumber, types_1.TypeOutput.BigInt);
        const td = (0, utils_1.toType)(_td, types_1.TypeOutput.BigInt);
        const timestamp = (0, utils_1.toType)(_timestamp, types_1.TypeOutput.Number);
    ...
    _calcForkHash(hardfork, genesisHash) {
        ...
        const forkhash = (0, utils_1.intToBuffer)((0, crc_32_1.buf)(inputBuffer) >>> 0).toString('hex');
        return `0x${forkhash}`;
    }
    /**
    ...
    static _getInitializedChains(customChains) {
        ...
        const chains = { mainnet: mainnet_json_1.default, goerli: goerli_json_1.default, sepolia: sepolia_json_1.default };
        if (customChains) {
