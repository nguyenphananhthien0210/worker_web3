...
exports.toType = exports.ecrecover = exports.bufArrToArr = exports.bigIntToUnpaddedBuffer = exports.bigIntToHex = exports.arrToBufArr = exports.unpadBuffer = exports.setLengthLeft = exports.assertIsBuffer = exports.zeros = exports.bigIntToBuffer = exports.bufferToBigInt = exports.bufferToHex = exports.toBuffer = exports.intToBuffer = exports.padToEven = exports.parseGethGenesis = exports.stripHexPrefix = void 0;
/*
...
const toBuffer = function (v) {
    ...
    if (typeof v === 'string') {
        ...
        return Buffer.from(padToEven((0, exports.stripHexPrefix)(v)), 'hex');
    }
    if (typeof v === 'number') {
 ...
 */
const bufferToHex = function (_buf) {
    const buf = (0, exports.toBuffer)(_buf);
...
const ecrecover = function (msgHash, v, r, s, chainId) {
    const signature = Buffer.concat([(0, exports.setLengthLeft)(r, 32), (0, exports.setLengthLeft)(s, 32)], 64);
...
function toType(input, outputType) {
    ...
    const output = (0, exports.toBuffer)(input);
    switch (outputType) {
        case types_1.TypeOutput.Buffer:
            return output;
        case types_1.TypeOutput.BigInt:
            return bufferToBigInt(output);
        case types_1.TypeOutput.Number: {
        ...
        case types_1.TypeOutput.PrefixedHexString:
            return (0, exports.bufferToHex)(output);
        default:
