...
import { arrToBufArr, bigIntToHex, bigIntToUnpaddedBuffer, bufArrToArr, bufferToBigInt, toBuffer, ecrecover, } from '../common/utils';
...
export class FeeMarketEIP1559Transaction extends BaseTransaction {
    ...
    constructor(txData, opts = {}) {
        ...
        this.maxPriorityFeePerGas = bufferToBigInt(toBuffer(maxPriorityFeePerGas === '' ? '0x' : maxPriorityFeePerGas));
    ...
    static fromValuesArray(values, opts = {}) {
        ...
        return new FeeMarketEIP1559Transaction({
            ...
            v: v !== undefined ? bufferToBigInt(v) : undefined,
            r,
            s,
        }, opts);
    }
    ...
    getSenderPublicKey() {
        ...
        try {
            ...
            bigIntToUnpaddedBuffer(r), bigIntToUnpaddedBuffer(s));
        }
        catch (e) {
