...
import { arrToBufArr, bigIntToHex, bigIntToUnpaddedBuffer, bufArrToArr, bufferToBigInt, toBuffer, ecrecover, unpadBuffer, } from '../common/utils';
...
export class Transaction extends BaseTransaction {
    ...
    getSenderPublicKey() {
        ...
        this._validateHighS();
        try {
            return ecrecover(msgHash, v, bigIntToUnpaddedBuffer(r), bigIntToUnpaddedBuffer(s), this.supports(Capability.EIP155ReplayProtection)
                ? this.common.chainId()
                : undefined);
        }
        catch (e) {
