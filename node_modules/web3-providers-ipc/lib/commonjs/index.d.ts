 ...
 * ```
 */
export default class IpcProvider<API extends Web3APISpec = EthExecutionAPI> extends SocketProvider<Buffer | string, CloseEvent, Error, API> {
    ...
    protected _parseResponses(e: Buffer | string): import("web3-types").JsonRpcResponse<import("web3-types").JsonRpcResult, import("web3-types").JsonRpcResult>[];
